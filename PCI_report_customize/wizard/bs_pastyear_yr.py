...
class bs_pastyear_yr(osv.osv_memory):
    _name = "bs.pastyear.yr"
    _description = "BS PastYear Yr"
    ...
    def _build_month_period(self, cr, uid, ids, data, context=None):
        ...
        if data['form']['cmp_type'] =='sequential':
            if data['form']['period_unit2'] =='month':
                print "period_unit2= 'month' cmp_type='sequential' \n"
                index_start = 1
                ...
                print "index_start=%s"% index_start
                ...
                for i in range(index_start,month+1):
                    ...
                    ln = {'date_start':date_start,'date_stop':date_stop,'title':code}
                    result.append(ln)
                ...
                if data['form']['date_from']:
                    ...
                    if month == 12:
                        ...
                        ln = {'date_start':date_start,'date_stop':date_stop,'title':title}
                        result.append(ln)
                    print "cccccc result=%s"% result
                    #raise osv.except_osv(_('Error!'),_("不再进行下去！！！！"))
                elif not data['form']['date_from']:
                    #计算第一个季度
                    if month >= 3:
                        date_start = date_to[:5] + '01-01'
                        date_stop = date_to[:5] + '03-31'
            ...
            if data['form']['period_unit'] =='year':
                ...
                if data['form']['two_years_go']:
                    ...
                    ln = {'fiscalyear_id':fiscalyear_ids[0],'title':code_3}
                    result.append(ln)
